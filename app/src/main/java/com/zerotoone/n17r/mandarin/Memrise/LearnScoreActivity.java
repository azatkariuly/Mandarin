...
import com.zerotoone.n17r.mandarin.MainActivity;
import com.zerotoone.n17r.mandarin.R;

public class LearnScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tryAgainBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LearnScoreActivity.this, LearnActivity.class));
            }
        });
